...
This project is a Kanban board application built using ReactJS. It allows users to interact with ticket data fetched from the [Quicksell API](https://api.quicksell.co/v1/internal/frontend-assignment). Users can group and sort tickets based on different criteria, making it a versatile tool for project management. See the project live at [Live Link](https://adarshjaiswal20.github.io/Quick-shell/)
.
...
1. **Clone the Repository:**
   ...
   ```bash
   git clone https://github.com/Adarshjaiswal20/Quick-shell
   ```
